...
<%@page import="in.co.rays.ctl.AttributeListCtl"%>
<%@page import="in.co.rays.bean.AttributeBean"%>
...
<body>
    ...
    <div align="center">
        <form action="<%= ORSView.ATTRIBUTE_LIST_CTL%>" method="post">
            ...
            <jsp:useBean id="bean" class="in.co.rays.bean.AttributeBean" scope="request"></jsp:useBean>
