...
<body>
    ...
    <div align="center">
        <form action="<%= ORSView.COLLEGE_LIST_CTL%>" method="post">
            ...
            <div align="center">
                <h1><font color="navy">College List</font></h1>
            </div>
            ...
            <table style="width: 100%">
                <tr>
                    <td align="center">
                        ...
                        <input type="text" name="address" value="<%= ServletUtility.getParameter("address", request) %>">&nbsp;
            ...
            <table border="1" style="width: 100%">
                ...
                %>
                <tr align="center">
                    <td><input type="checkbox" class="case" name="ids" value="<%=collegeBean.getId() %>"></td>
                    <td><%= index++ %></td>
                    <td><%= collegeBean.getName() %></td>
                    <td><%= collegeBean.getAddress() %></td>
                    <td><%= collegeBean.getState()%></td>
                    <td><%= collegeBean.getCity()%></td>
                    <td><%= collegeBean.getPhoneNo()%></td>
                    <td><a href="<%= ORSView.COLLEGE_CTL %>?id=<%= collegeBean.getId() %>">edit</a></td>
                </tr>
                <%
                    }
                %>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="width: 30%">
                        <input type="submit" name="operation" value="<%= CollegeListCtl.OP_PREVIOUS %>" 
                               <%= (pageNo == 1) ? "disabled" : "" %>>
                    </td>
                    <td style="width: 30%">
                    ...
                    <td style="text-align: right;">
                        <input type="submit" name="operation" value="<%= CollegeListCtl.OP_NEXT %>" 
            ...
            <table>
                ...
                <tr>
                    <td align="right"><input type="submit" name="operation" value="<%= CollegeListCtl.OP_BACK %>"></td>
                </tr>
            </table>
            <% } %>
        </form>
