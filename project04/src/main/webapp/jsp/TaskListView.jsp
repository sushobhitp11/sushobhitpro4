...
<body>
    ...
    <div align="center">
        <form action="<%= ORSView.TASK_LIST_CTL%>" method="post">
            ...
            <jsp:useBean id="bean" class="in.co.rays.bean.TaskBean" scope="request"></jsp:useBean>
            ...
            <table>
                ...
                <tr>
                    <td align="right"><input type="submit" name="operation" value="<%= TaskListCtl.OP_BACK %>"></td>
                </tr>
            </table>
            <% } %>
        </form>
